            ...
            <div class="left_top_zuo">
                ...
                <div class="scdt">
                    ...
                    <c:forEach items="${WOMAN_LIST}" var="woman_list" begin="0" end="0">
                        <a href="/detail/${woman_list.id}" title="${woman_list.title}"><img src="/images/scdt.jpg" width="140px" height="113px" alt="" /></a>
                        <h2><a href="/detail/${woman_list.id}" title="${woman_list.title}">${woman_list.title}</a></h2>
                        <p>${woman_list.words}<a href="/detail/${woman_list.id}" title="${woman_list.title}">[详细]</a></p>
                    </c:forEach>
                    </div><!--intro end-->
                    <div class="list">
                        <ul>
                            <c:forEach items="${WOMAN_LIST}" var="woman_list" begin="1" varStatus="vs">
                             <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a href="/detail/${woman_list.id}" title="">${woman_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div><!--list end-->
                </div><!--scdt end-->
                <div class="hyaq">
                    ...
                    <c:forEach items="${SEX_LIST}" var="sex_list" begin="0" end="0">
                        <a href="/detail/${sex_list.id}" title="${sex_list.title}"><img src="/images/hyaq.jpg" width="140px" height="113px" alt="" /></a>
                    ...
                    <div class="list">
                        <ul>
                            <c:forEach items="${SEX_LIST}" begin="1" var="sex_list">
                                <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a href="/detail/${sex_list.id}" title="">${sex_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div><!--list end-->
                </div><!--hyaq end-->
                    ...
                    <div class="list">
                        <ul>
                            <c:forEach items="${HEALTH_LIST}" begin="1" var="health_list">
                                <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a href="/detail/${health_list.id}" title="">${health_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div><!--list end-->
                </div><!--ppzs end-->
            ...
            <div class="left_top_you">
                    ...
                    <div class="list">
                        <ul>
                            <li class="li1">
                                ...
                                <h2><a target="_blank" href="/detail/${week_list.id}" title="${week_list.title}">${week_list.title}</a></h2>
                                <p>${week_list.words}<a target="_blank" href="/detail/${week_list.id}" title="${week_list.title}">[详细]</a></p>
                                </c:forEach>
                            </li>
                            <c:forEach items="${WEEK_LIST}" begin="1" var="week_list">
                                <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a target="_blank" href="/detail/${week_list.id}" title="">${week_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div>
                </div><!--hyyw end-->
                    ...
                    <div class="list">
                        <ul>
                            <li class="li1">
                                ...
                                <h2><a target="_blank" href="/detail/${man_list.id}" title="${man_list.title}">${man_list.title}</a></h2>
                                <p>${man_list.words}<a target="_blank" href="/detail/${man_list.id}" title="${man_list.title}">[详细]</a></p>
                                </c:forEach>
                            </li>
                            <c:forEach items="${MAN_LIST}" begin="1" var="man_list">
                                <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a target="_blank" href="/detail/${man_list.id}" title="">${man_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div>
                </div><!--hyfx end-->
                <div class="dfdt">
                    ...
                    <div class="intro">
                        ...
                        <a target="_blank" href="/detail/${physiology_list.id}" title="${physiology_list.title}"><img src="/images/dfdt.jpg" width="140px" height="113px" alt="" /></a>
                        <h2><a target="_blank" href="/detail/${physiology_list.id}" title="${physiology_list.title}">${physiology_list.title}</a></h2>
                        <p>${physiology_list.words}<a target="_blank" href="/detail/${physiology_list.id}" title="${physiology_list.title}">[详细]</a></p>
                        </c:forEach>
                    </div><!--intro end-->
                    <div class="list">
                        <ul>
                            <c:forEach items="${Physiology_LIST}" begin="1" var="physiology_list">
                                <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a target="_blank" href="/detail/${physiology_list.id}" title="">${physiology_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div><!--list end-->
                </div><!--dfdt end-->
                <div class="zhxx">
                    ...
                    <div class="intro">
                        ...
                        <a target="_blank" href="/detail/${cold_list.id}" title="${cold_list.title}"><img src="/images/dfdt.jpg" width="140px" height="113px" alt="" /></a>
                        <h2><a target="_blank" href="/detail/${cold_list.id}" title="${cold_list.title}">${cold_list.title}</a></h2>
                        <p>${cold_list.words}<a target="_blank" href="/detail/${cold_list.id}" title="${cold_list.title}">[详细]</a></p>
                        </c:forEach>
                    </div><!--intro end-->
                    <div class="list">
                        <ul>
                            <c:forEach items="${COLD_LIST}" begin="1" var="cold_list">
                                <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a target="_blank" href="/detail/${cold_list.id}" title="">${cold_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div><!--list end-->
                </div><!--zhxx end-->
            ...
            <div class="left_under_zuo">
                <div class="mjgf">
                    ...
                    <div class="intro">
                        ...
                        <a target="_blank" href="" title="/detail/${young_list.id}"><img src="/images/mjgf.jpg" width="140px" height="113px" alt="" /></a>
                        <h2><a target="_blank" href="/detail/${young_list.id}" title="${young_list.title}">${young_list.title}</a></h2>
                        <p>${young_list.words}<a target="_blank" href="/detail/${young_list.id}" title="${young_list.title}">[详细]</a></p>
                        </c:forEach>
                    </div><!--intro end-->
                    <div class="list">
                        <ul>
                            <c:forEach items="${YOUNG_LIST}" begin="1" var="young_list">
                                <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a target="_blank" href="/detail/${young_list.id}" title="">${young_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div><!--list end-->
                </div><!--mjgf end-->
            ...
            <div class="left_under_you">
                ...
                <div class="mjgf">
                    ...
                    <div class="intro">
                        ...
                        <a target="_blank" href="/detail/${history_list.id}" title="${history_list.title}"><img src="/images/rsrg.jpg" width="140px" height="113px" alt="" /></a>
                        <h2><a target="_blank" href="/detail/${history_list.id}" title="${history_list.title}">${history_list.title}</a></h2>
                        <p>${history_list.words}<a target="_blank" href="/detail/${history_list.id}" title="${history_list.title}">[详细]</a></p>
                        </c:forEach>
                    </div><!--intro end-->
                    <div class="list">
                        <ul>
                            <c:forEach items="${HISTORY_LIST}" begin="1" var="history_list">
                                <li><img src="/images/dian.png" width="5px" height="5px" alt="" /><a target="_blank" href="/detail/${history_list.id}" title="">${history_list.title}</a></li>
                            </c:forEach>
                        </ul>
                    </div><!--list end-->
                </div><!--mjgf end-->
...
<div class="footer">
    <ul>
        ...
        <li class="li_right"><a href="" title="">Archiver</a>&nbsp;|&nbsp;<span><a href="" title="">桥帮主工作室</a></span>&nbsp;( 鄂ICP备15020852-1号 )&nbsp;<a href="" title="">站长统计</a></li>
