...
<div class="button_content" style="float: right;margin-right:48px;">
    <div class="pull-right">
        <div class="btn-group"><input type="text" readonly style="width: 80px" class="btn btn-primary btn-sm addbtn"
                                      data-toggle="modal" data-target="#addModal" onclick="addUrl()" value="新建链接"/>
        </div>
    </div>
</div>
    ...
    <div id="myTabContent" class="tab-content">
        <table class="table table-bordered table-hover  table-condensed tablesorter" style="width:99%;">
            ...
            <tr>
                ...
                <th sorter="true" style="text-align: left; width: 120px;background-color: #f7f7f7;">名称
                    <div class="ui-table-hsort skin-noGrid-table-hsort"></div>
                </th>
                <th sorter="true" style="text-align: left; width: 100px;background-color: #f7f7f7;">链接
                    <div class="ui-table-hsort skin-noGrid-table-hsort"></div>
                </th>
                ...
                <th sorter="true" style="text-align: left; width: 60px;background-color: #f7f7f7;">状态
                    <div class="ui-table-hsort skin-noGrid-table-hsort"></div>
                </th>
            ...
            <c:forEach items="${pageInfo.list }" var="list" varStatus="vs">
                <tr id="tr_${list.id}" class="trs">
                    ...
                    <td style="line-height: 30px;">
                        <input type="text" readonly style="width: 80px" class="btn btn-primary btn-sm addbtn"
                               onclick="updateUrl(${list.id})" value="修改"/>
                        <input type="text" readonly style="width: 80px" class="btn btn-primary btn-sm addbtn"
                               onclick="updateStatus(${list.id},1)" value="启用"/>
                        <input type="text" readonly style="width: 80px" class="btn btn-primary btn-sm addbtn"
                               onclick="updateStatus(${list.id},0)" value="停用"/>
                        <input type="text" readonly style="width: 80px" class="btn btn-primary btn-sm addbtn"
                               onclick="deleteUrl(${list.id})" value="删除"/>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
        ...
        <div class="modal-content" style="min-width: 500px;top:120px;">
            ...
            <form id="addUrl" class="form-horizontal" style="display: block;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm" id="add_btn" style="" onclick="addBtn()">新建链接
                    </button>
                    <button type="button" id="modalmiss" class="btn btn-default btn-sm" data-dismiss="modal">取 消
                    </button>
                </div>
            </form>
        </div>
            ...
            <form id="updateUrl" class="form-horizontal" style="display: block;">
                <div class="modal-body" style="padding-top: 0px;">
                    ...
                    <div class="control-group">
                        <label class="control-label" style="color: #131212;">名称：</label>
                        <span style="color:red; margin-left:18px;">*</span>&nbsp;&nbsp;
                        <input type="text" id="update_name" placeholder="请输入站点名称"
                               style="width: 300px; text-indent: 0.2em;">
                    </div>
                    <div class="control-group">
                        <label class="control-label" style="color: #131212;">链接：</label>
                        <span style="color:red;margin-left: 20px;">*</span>&nbsp;&nbsp;
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary btn-sm" id="update_btn" style=""
                            onclick="commitUpdate()">提交修改
                    </button>
