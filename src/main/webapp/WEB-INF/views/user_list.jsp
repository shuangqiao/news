    ...
    <div id="myTabContent" class="tab-content">
        <table class="table table-bordered table-hover  table-condensed tablesorter" style="width:99%;">
            ...
            <tr>
                ...
                <th sorter="true" style="text-align: left; width: 180px;background-color: #f7f7f7;">用户名
                    <div class="ui-table-hsort skin-noGrid-table-hsort"></div>
                </th>
                <th sorter="true" style="text-align: left; width: 120px;background-color: #f7f7f7;">密码
                    <div class="ui-table-hsort skin-noGrid-table-hsort"></div>
                </th>
                ...
                <th sorter="true" style="text-align: left; width: 100px;background-color: #f7f7f7;">注册时间
                    <div class="ui-table-hsort skin-noGrid-table-hsort"></div>
                </th>
            </tr>
            </thead>
